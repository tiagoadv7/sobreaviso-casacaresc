      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-[#fcfcfb] border border-black/10 rounded-3xl p-6 shadow-xs flex flex-col justify-between hover:border-black/20 transition-all">
            <div>
              <div className="flex items-center justify-center gap-1.5 lg:justify-between mb-1">
                <h3 className="text-sm font-bold text-neutral-900 text-center lg:text-left">Distribuição por Tipo de Demanda</h3>
                <BarChart3 className="w-4 h-4 text-neutral-400 shrink-0" />
              </div>
              <p className="text-xs text-neutral-400 text-center lg:text-left">Quantidade de registros por categoria</p>
            </div>
          ...
          <div className="bg-[#fcfcfb] border border-black/10 rounded-3xl p-6 shadow-xs flex flex-col justify-between hover:border-black/20 transition-all">
            <div>
              <div className="flex items-center justify-center gap-1.5 lg:justify-between mb-1">
                <h3 className="text-sm font-bold text-neutral-900 text-center lg:text-left">Atendimentos por Colaboradora</h3>
                <Users className="w-4 h-4 text-neutral-400 shrink-0" />
              </div>
              <p className="text-xs text-neutral-400 text-center lg:text-left">Carga de chamados atendidos por pessoa</p>
            </div>
          ...
          <div className="bg-[#fcfcfb] border border-black/10 rounded-3xl p-6 shadow-xs flex flex-col justify-between hover:border-black/20 transition-all">
            <div>
              <div className="flex items-center justify-center gap-1.5 lg:justify-between mb-1">
                <h3 className="text-sm font-bold text-neutral-900 text-center lg:text-left">Status dos Atendimentos</h3>
                <PieChart className="w-4 h-4 text-neutral-400 shrink-0" />
              </div>
              <p className="text-xs text-neutral-400 text-center lg:text-left">Concluídos vs Pendentes no período</p>
            </div>
